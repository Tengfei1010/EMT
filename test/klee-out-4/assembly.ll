; ModuleID = '/home/kevin/Develop/EMT/test/cr_t.c.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

@.str = private unnamed_addr constant [2 x i8] c"0\00", align 1
@.str1 = private unnamed_addr constant [35 x i8] c"/home/kevin/Develop/EMT/src/cr_t.c\00", align 1
@__PRETTY_FUNCTION__.cr_t = private unnamed_addr constant [14 x i8] c"int cr_t(int)\00", align 1
...
define i32 @is_prime(i32 %a) #0 {
  ...
  %3 = load i32* %2, align 4, !dbg !135
  %4 = icmp sgt i32 %3, 1, !dbg !135
  br i1 %4, label %5, label %20, !dbg !135

; <label>:5                                       ; preds = %0
  store i32 2, i32* %i, align 4, !dbg !137
  br label %6, !dbg !137

; <label>:6                                       ; preds = %17, %5
  %7 = load i32* %i, align 4, !dbg !137
  %8 = load i32* %2, align 4, !dbg !137
  %int_cast_to_i64 = zext i32 2 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !137
  %9 = sdiv i32 %8, 2, !dbg !137
  %10 = icmp sle i32 %7, %9, !dbg !137
...
; <label>:11                                      ; preds = %6
  ...
  %14 = srem i32 %12, %13, !dbg !140
  %15 = icmp eq i32 %14, 0, !dbg !140
  br i1 %15, label %16, label %17, !dbg !140
...
; <label>:17                                      ; preds = %11
  %18 = load i32* %i, align 4, !dbg !137
  %19 = add nsw i32 %18, 1, !dbg !137
  store i32 %19, i32* %i, align 4, !dbg !137
  br label %6, !dbg !137
...
; Function Attrs: nounwind uwtable
define i32 @cr_t(i32 %a) #0 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  store i32 %a, i32* %2, align 4
  %3 = load i32* %2, align 4, !dbg !149
  %4 = call i32 @is_prime(i32 %3), !dbg !149
  %5 = icmp ne i32 %4, 0, !dbg !149
  br i1 %5, label %6, label %12, !dbg !149

; <label>:6                                       ; preds = %0
  %7 = load i32* %2, align 4, !dbg !151
  %int_cast_to_i64 = zext i32 3 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !151
  %8 = srem i32 %7, 3, !dbg !151
  %9 = icmp ne i32 %8, 1, !dbg !151
  br i1 %9, label %10, label %12, !dbg !151

; <label>:10                                      ; preds = %6
  %11 = call i32 (i8*, i8*, i32, i8*, ...)* bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8]* @.str1, i32 0, i32 0), i32 24, i8* getele
  br label %12, !dbg !156

; <label>:12                                      ; preds = %6, %10, %0
  %13 = load i32* %1, !dbg !157
  ret i32 %13, !dbg !157
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = bitcast i32* %a to i8*, !dbg !158
  call void @klee_make_symbolic(i8* %2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str2, i32 0, i32 0)), !dbg !158
  %3 = load i32* %a, align 4, !dbg !159
  %4 = call i32 @cr_t(i32 %3), !dbg !159
  ret i32 0, !dbg !160
}
...
; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([62 x i8]* @.str14, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str12, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str25, i64 0, i64 0)) #8, !dbg !172
  unreachable, !dbg !172
...
; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([53 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #8, !dbg !185
  unreachable, !dbg !185
...
!1 = metadata !{metadata !"/home/kevin/Develop/EMT/src/cr_t.c", metadata !"/home/kevin/Develop/EMT"}
!2 = metadata !{i32 0}
!3 = metadata !{metadata !4, metadata !9, metadata !10}
!4 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"is_prime", metadata !"is_prime", metadata !"", i32 7, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32)* @is_prime, null, null, metadata !2, i32 7} ; [ DW_TAG
!5 = metadata !{i32 786473, metadata !1}          ; [ DW_TAG_file_type ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!6 = metadata !{i32 786453, i32 0, null, metadata !"", i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !7, i32 0, null, null, null} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!7 = metadata !{metadata !8, metadata !8}
!8 = metadata !{i32 786468, null, null, metadata !"int", i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ] [int] [line 0, size 32, align 32, offset 0, enc DW_ATE_signed]
!9 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"cr_t", metadata !"cr_t", metadata !"", i32 21, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32)* @cr_t, null, null, metadata !2, i32 21} ; [ DW_TAG_subprogra
!10 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 29, metadata !11, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 29} ; [ DW_TAG_subprogram ]
...
!14 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/klee_choose.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!17 = metadata !{i32 786473, metadata !14}        ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_choose.c]
!18 = metadata !{i32 786453, i32 0, null, metadata !"", i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !19, i32 0, null, null, null} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!19 = metadata !{metadata !20, metadata !20}
!20 = metadata !{i32 786454, metadata !14, null, metadata !"uintptr_t", i32 123, i64 0, i64 0, i64 0, i32 0, metadata !21} ; [ DW_TAG_typedef ] [uintptr_t] [line 123, size 0, align 0, offset 0] [from long unsigned int]
...
!25 = metadata !{i32 786449, metadata !26, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !27, metadata !2, metadata !2, metadata !""} ; [ DW_TA
!26 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/klee_div_zero_check.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!29 = metadata !{i32 786473, metadata !26}        ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_div_zero_check.c]
...
!35 = metadata !{i32 786449, metadata !36, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !37, metadata !2, metadata !2, metadata !""} ; [ DW_TA
!36 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/klee_int.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!39 = metadata !{i32 786473, metadata !36}        ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_int.c]
...
!48 = metadata !{i32 786449, metadata !49, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !50, metadata !2, metadata !2, metadata !""} ; [ DW_TA
!49 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/klee_overshift_check.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!52 = metadata !{i32 786473, metadata !49}        ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_overshift_check.c]
...
!60 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!63 = metadata !{i32 786473, metadata !60}        ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c]
...
!71 = metadata !{i32 786449, metadata !72, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !73, metadata !2, metadata !2, metadata !""} ; [ DW_TA
!72 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/memcpy.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!75 = metadata !{i32 786473, metadata !72}        ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/memcpy.c]
...
!89 = metadata !{i32 786449, metadata !90, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !91, metadata !2, metadata !2, metadata !""} ; [ DW_TA
!90 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/memmove.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!93 = metadata !{i32 786473, metadata !90}        ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/memmove.c]
...
!103 = metadata !{i32 786449, metadata !104, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !105, metadata !2, metadata !2, metadata !""} ; [ DW
!104 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/mempcpy.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!107 = metadata !{i32 786473, metadata !104}      ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/mempcpy.c]
...
!117 = metadata !{i32 786449, metadata !118, i32 1, metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)", i1 true, metadata !"", i32 0, metadata !2, metadata !2, metadata !119, metadata !2, metadata !2, metadata !""} ; [ DW
!118 = metadata !{metadata !"/home/kevin/Klee/klee/runtime/Intrinsic/memset.c", metadata !"/home/kevin/Klee/klee/build/runtime/Intrinsic"}
...
!121 = metadata !{i32 786473, metadata !118}      ; [ DW_TAG_file_type ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/memset.c]
...
!134 = metadata !{metadata !"Ubuntu clang version 3.4.2- (branches/release_34) (based on LLVM 3.4.2)"}
!135 = metadata !{i32 8, i32 0, metadata !136, null} ; [ DW_TAG_imported_declaration ]
!136 = metadata !{i32 786443, metadata !1, metadata !4, i32 8, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!137 = metadata !{i32 9, i32 0, metadata !138, null}
!138 = metadata !{i32 786443, metadata !1, metadata !139, i32 9, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!139 = metadata !{i32 786443, metadata !1, metadata !136, i32 8, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!140 = metadata !{i32 10, i32 0, metadata !141, null}
!141 = metadata !{i32 786443, metadata !1, metadata !142, i32 10, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!142 = metadata !{i32 786443, metadata !1, metadata !138, i32 9, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!143 = metadata !{i32 11, i32 0, metadata !144, null}
!144 = metadata !{i32 786443, metadata !1, metadata !141, i32 10, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!145 = metadata !{i32 15, i32 0, metadata !146, null}
!146 = metadata !{i32 786443, metadata !1, metadata !136, i32 14, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!147 = metadata !{i32 18, i32 0, metadata !4, null}
!148 = metadata !{i32 19, i32 0, metadata !4, null}
!149 = metadata !{i32 22, i32 0, metadata !150, null}
!150 = metadata !{i32 786443, metadata !1, metadata !9, i32 22, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!151 = metadata !{i32 23, i32 0, metadata !152, null}
!152 = metadata !{i32 786443, metadata !1, metadata !153, i32 23, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!153 = metadata !{i32 786443, metadata !1, metadata !150, i32 22, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!154 = metadata !{i32 24, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !1, metadata !152, i32 23, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/cr_t.c]
!156 = metadata !{i32 25, i32 0, metadata !155, null}
!157 = metadata !{i32 27, i32 0, metadata !9, null}
!158 = metadata !{i32 31, i32 0, metadata !10, null}
!159 = metadata !{i32 32, i32 0, metadata !10, null}
!160 = metadata !{i32 33, i32 0, metadata !10, null}
!161 = metadata !{i32 14, i32 0, metadata !16, null}
!162 = metadata !{i32 17, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !14, metadata !16, i32 17, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_choose.c]
...
!169 = metadata !{i32 19, i32 0, metadata !16, null}
!170 = metadata !{i32 13, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !26, metadata !28, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_div_zero_check.c]
!172 = metadata !{i32 14, i32 0, metadata !171, null}
!173 = metadata !{i32 15, i32 0, metadata !28, null}
!174 = metadata !{i32 15, i32 0, metadata !38, null}
!175 = metadata !{i32 16, i32 0, metadata !38, null}
...
!179 = metadata !{i32 786443, metadata !49, metadata !51, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!180 = metadata !{i32 27, i32 0, metadata !181, null}
!181 = metadata !{i32 786443, metadata !49, metadata !179, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_overshift_check.c]
!182 = metadata !{i32 29, i32 0, metadata !51, null}
!183 = metadata !{i32 16, i32 0, metadata !184, null}
!184 = metadata !{i32 786443, metadata !60, metadata !62, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c]
!185 = metadata !{i32 17, i32 0, metadata !184, null}
!186 = metadata !{i32 19, i32 0, metadata !187, null}
!187 = metadata !{i32 786443, metadata !60, metadata !62, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c]
!188 = metadata !{i32 22, i32 0, metadata !189, null}
!189 = metadata !{i32 786443, metadata !60, metadata !187, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c]
!190 = metadata !{i32 25, i32 0, metadata !191, null}
!191 = metadata !{i32 786443, metadata !60, metadata !189, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c]
!192 = metadata !{i32 26, i32 0, metadata !193, null}
!193 = metadata !{i32 786443, metadata !60, metadata !191, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c]
!194 = metadata !{i32 27, i32 0, metadata !193, null}
!195 = metadata !{i32 28, i32 0, metadata !196, null}
!196 = metadata !{i32 786443, metadata !60, metadata !191, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/klee_range.c]
!197 = metadata !{i32 29, i32 0, metadata !196, null}
!198 = metadata !{i32 32, i32 0, metadata !189, null}
!199 = metadata !{i32 34, i32 0, metadata !62, null}
!200 = metadata !{i32 16, i32 0, metadata !74, null}
!201 = metadata !{i32 17, i32 0, metadata !74, null}
...
!207 = metadata !{i32 18, i32 0, metadata !74, null}
!208 = metadata !{i32 16, i32 0, metadata !209, null}
!209 = metadata !{i32 786443, metadata !90, metadata !92, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/memmove.c]
!210 = metadata !{i32 19, i32 0, metadata !211, null}
!211 = metadata !{i32 786443, metadata !90, metadata !92, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/memmove.c]
!212 = metadata !{i32 20, i32 0, metadata !213, null}
!213 = metadata !{i32 786443, metadata !90, metadata !211, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/memmove.c]
...
!217 = metadata !{i32 786443, metadata !90, metadata !211, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/kevin/Klee/klee/build/runtime/Intrinsic//home/kevin/Klee/klee/runtime/Intrinsic/memmove.c]
...
!222 = metadata !{i32 28, i32 0, metadata !92, null}
!223 = metadata !{i32 15, i32 0, metadata !106, null}
!224 = metadata !{i32 16, i32 0, metadata !106, null}
!225 = metadata !{metadata !225, metadata !203, metadata !204}
!226 = metadata !{metadata !226, metadata !203, metadata !204}
!227 = metadata !{i32 17, i32 0, metadata !106, null}
!228 = metadata !{i32 13, i32 0, metadata !120, null}
!229 = metadata !{i32 14, i32 0, metadata !120, null}
!230 = metadata !{i32 15, i32 0, metadata !120, null}
