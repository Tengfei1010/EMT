...
define i32 @fmsts_t(i32 %x, i32 %y) #0 {
  ...
  %4 = call i32 @umul_ok(i32 %3, i32 2), !dbg !168
  %5 = icmp ne i32 %4, 0, !dbg !168
  br i1 %5, label %6, label %36, !dbg !168

; <label>:6                                       ; preds = %0
  %7 = load i32* %2, align 4, !dbg !168
  %8 = call i32 @umul_ok(i32 %7, i32 2), !dbg !168
  %9 = icmp ne i32 %8, 0, !dbg !168
  br i1 %9, label %10, label %36, !dbg !168

; <label>:10                                      ; preds = %6
  %11 = load i32* %1, align 4, !dbg !170
  %12 = load i32* %1, align 4, !dbg !170
  %13 = mul nsw i32 %11, %12, !dbg !170
  store i32 %13, i32* %t_1, align 4, !dbg !170
  %14 = load i32* %2, align 4, !dbg !172
  %15 = load i32* %2, align 4, !dbg !172
  %16 = mul nsw i32 %14, %15, !dbg !172
  store i32 %16, i32* %t_2, align 4, !dbg !172
  %17 = load i32* %t_1, align 4, !dbg !173
  %18 = load i32* %t_2, align 4, !dbg !173
  %19 = call i32 @add_ok(i32 %17, i32 %18), !dbg !173
  %20 = icmp ne i32 %19, 0, !dbg !173
  br i1 %20, label %21, label %36, !dbg !173

; <label>:21                                      ; preds = %10
  %22 = load i32* %t_1, align 4, !dbg !173
  %23 = load i32* %t_2, align 4, !dbg !173
  %24 = add nsw i32 %22, %23, !dbg !173
  %25 = call i32 @is_prime(i32 %24), !dbg !173
  %26 = icmp ne i32 %25, 0, !dbg !173
  br i1 %26, label %27, label %36, !dbg !173

; <label>:27                                      ; preds = %21
  %28 = load i32* %t_1, align 4, !dbg !175
  %29 = load i32* %t_2, align 4, !dbg !175
  %30 = add nsw i32 %28, %29, !dbg !175
  store i32 %30, i32* %sum, align 4, !dbg !175
  %31 = load i32* %sum, align 4, !dbg !177
  %int_cast_to_i64 = zext i32 4 to i64
  call void @klee_div_zero_check(i64 %int_cast_to_i64), !dbg !177
  %32 = srem i32 %31, 4, !dbg !177
  %33 = icmp ne i32 %32, 1, !dbg !177
  br i1 %33, label %34, label %36, !dbg !177

; <label>:34                                      ; preds = %27
  %35 = call i32 (i8*, i8*, i32, i8*, ...)* bitcast (i32 (...)* @__assert_fail to i32 (i8*, i8*, i32, i8*, ...)*)(i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8]* @.str1, i32 0, i32 0), i32 53, i8* getele
  br label %36, !dbg !181

; <label>:36                                      ; preds = %10, %21, %34, %27, %6, %0
  ret i32 1, !dbg !182
}
...
!10 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"add_ok", metadata !"add_ok", metadata !"", i32 25, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i32)* @add_ok, null, null, metadata !2, i32 25} ; [ DW_T
!11 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"is_prime", metadata !"is_prime", metadata !"", i32 32, metadata !12, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32)* @is_prime, null, null, metadata !2, i32 32} ; [ DW
!12 = metadata !{i32 786453, i32 0, null, metadata !"", i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !13, i32 0, null, null, null} ; [ DW_TAG_subroutine_type ] [line 0, size 0, align 0, offset 0] [from ]
!13 = metadata !{metadata !8, metadata !8}
!14 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"fmsts_t", metadata !"fmsts_t", metadata !"", i32 46, metadata !6, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i32)* @fmsts_t, null, null, metadata !2, i32 46} ; [ D
!15 = metadata !{i32 786478, metadata !1, metadata !5, metadata !"main", metadata !"main", metadata !"", i32 60, metadata !16, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, i32 ()* @main, null, null, metadata !2, i32 60} ; [ DW_TAG_subprogram ]
...
!148 = metadata !{i32 26, i32 0, metadata !149, null}
!149 = metadata !{i32 786443, metadata !1, metadata !10, i32 26, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!150 = metadata !{i32 27, i32 0, metadata !151, null}
!151 = metadata !{i32 786443, metadata !1, metadata !149, i32 26, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!152 = metadata !{i32 29, i32 0, metadata !10, null}
!153 = metadata !{i32 30, i32 0, metadata !10, null}
!154 = metadata !{i32 33, i32 0, metadata !155, null}
!155 = metadata !{i32 786443, metadata !1, metadata !11, i32 33, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!156 = metadata !{i32 34, i32 0, metadata !157, null}
!157 = metadata !{i32 786443, metadata !1, metadata !158, i32 34, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!158 = metadata !{i32 786443, metadata !1, metadata !155, i32 33, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!159 = metadata !{i32 35, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !1, metadata !161, i32 35, i32 0, i32 8} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!161 = metadata !{i32 786443, metadata !1, metadata !157, i32 34, i32 0, i32 7} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!162 = metadata !{i32 36, i32 0, metadata !163, null}
!163 = metadata !{i32 786443, metadata !1, metadata !160, i32 35, i32 0, i32 9} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!164 = metadata !{i32 40, i32 0, metadata !165, null}
!165 = metadata !{i32 786443, metadata !1, metadata !155, i32 39, i32 0, i32 10} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!166 = metadata !{i32 43, i32 0, metadata !11, null}
!167 = metadata !{i32 44, i32 0, metadata !11, null}
!168 = metadata !{i32 47, i32 0, metadata !169, null}
!169 = metadata !{i32 786443, metadata !1, metadata !14, i32 47, i32 0, i32 11} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!170 = metadata !{i32 48, i32 0, metadata !171, null}
!171 = metadata !{i32 786443, metadata !1, metadata !169, i32 47, i32 0, i32 12} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!172 = metadata !{i32 49, i32 0, metadata !171, null}
!173 = metadata !{i32 50, i32 0, metadata !174, null}
!174 = metadata !{i32 786443, metadata !1, metadata !171, i32 50, i32 0, i32 13} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!175 = metadata !{i32 51, i32 0, metadata !176, null}
!176 = metadata !{i32 786443, metadata !1, metadata !174, i32 50, i32 0, i32 14} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!177 = metadata !{i32 52, i32 0, metadata !178, null}
!178 = metadata !{i32 786443, metadata !1, metadata !176, i32 52, i32 0, i32 15} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!179 = metadata !{i32 53, i32 0, metadata !180, null}
!180 = metadata !{i32 786443, metadata !1, metadata !178, i32 52, i32 0, i32 16} ; [ DW_TAG_lexical_block ] [/home/kevin/Develop/EMT//home/kevin/Develop/EMT/src/fmsts_t.c]
!181 = metadata !{i32 54, i32 0, metadata !180, null}
!182 = metadata !{i32 57, i32 0, metadata !14, null}
!183 = metadata !{i32 62, i32 0, metadata !15, null}
!184 = metadata !{i32 63, i32 0, metadata !15, null}
!185 = metadata !{i32 64, i32 0, metadata !15, null}
!186 = metadata !{i32 65, i32 0, metadata !15, null}
